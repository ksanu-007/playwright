...
test('Verify user can login and create conversation with message "New Test Conversation"', async ({ page }) => {
  ...
  try {
    ...
    await common.fill(conversationPageLocator.searchUserName, testData.conversationTestData.user1);
...
test('Verify user create conversation', async ({ page }) => {
    ...
    await common.click(conversationPageLocator.createButton);
    await page.waitForTimeout(5000);
    await common.fill(conversationPageLocator.writeMessage, testData.conversationTestData.message);
    await common.click(conversationPageLocator.sendButton);
    await page.waitForTimeout(5000);
...
test('Verify EditParticipants Functionality with Multiple users', async ({ page }) => {
    ...
    await common.click(conversationPageLocator.searchUserName);
    await common.fill(conversationPageLocator.searchUserName, testData.conversationTestData.user2);
    await page.waitForTimeout(5000);
    ...
    await common.click(conversationPageLocator.EditPArticipantsButton);
    await common.click(conversationPageLocator.searchUserName);
    await common.fill(conversationPageLocator.searchUserName, testData.conversationTestData.user3);
    await page.waitForTimeout(10000);
...
test('Verify Creating Poll', async ({ page }) => {
    ...
    await common.fill(conversationPageLocator.enterpollquestion, testData.conversationTestData.pollquestion);
    await common.fill(conversationPageLocator.enteroption1, testData.conversationTestData.option1);
    await common.fill(conversationPageLocator.enteroption2, testData.conversationTestData.option2);
    await common.click(conversationPageLocator.sendButton);
